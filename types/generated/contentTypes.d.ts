...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Quiz questions with multilingual support';
  ...
  attributes: {
    baseId: Schema.Attribute.String &
...
export interface ApiQuizEngineQuizSession extends Struct.CollectionTypeSchema {
  collectionName: 'quiz_sessions';
  info: {
    description: 'Quiz game session data for persistent storage';
    displayName: 'Quiz Session';
    pluralName: 'quiz-sessions';
    singularName: 'quiz-session';
  };
  options: {
    comment: 'Stores quiz session state for resumability and analytics';
    draftAndPublish: false;
  };
  pluginOptions: {
    i18n: {
  ...
  attributes: {
    ...
    autoSaveEnabled: Schema.Attribute.Boolean &
    ...
    currentQuestionStartTime: Schema.Attribute.DateTime &
      Schema.Attribute.Required;
    isPaused: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    lastAutoSave: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::quiz-engine.quiz-session'
    > &
      Schema.Attribute.Private;
    ...
    pauseDuration: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    phaseConfig: Schema.Attribute.JSON & Schema.Attribute.Required;
    phaseNumber: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    phaseResult: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    ...
    userPreferences: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<{}>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::quiz-engine.quiz-session': ApiQuizEngineQuizSession;
